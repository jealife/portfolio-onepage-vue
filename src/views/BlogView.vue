<template>
  <section class="py-24">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <h2 class="font-manrope text-4xl font-bold text-white text-center mb-14">
        Our popular blogs
      </h2>
      <div
      ...
      >
        <div
          class="group cursor-pointer w-full max-lg:max-w-xl lg:w-1/3 border border-gray-300 rounded-2xl p-5 transition-all duration-300 hover:border-green-600"
        >
          ...
          <div class="block">
            ...
            <div class="flex items-center justify-between font-medium">
              ...
              <span class="text-sm text-green-600">2 year ago</span>
            </div>
          </div>
        </div>
        <div
      ...
      <a
        href="javascript:;"
        class="cursor-pointer border border-gray-300 shadow-sm rounded-full py-3.5 px-7 w-52 flex justify-center items-center text-white font-semibold mx-auto transition-all duration-300 hover:bg-green-800"
        >View All</a
      >
    </div>
  </section>
